...
export const availableCoins: CoinsMap<CoinOpts> = {
  ...
  bcd: {
    ...
    paymentInfo: {
      paymentCode: 'BIP73',
      protocolPrefix: { livenet: 'bitcoindiamond', testnet: 'bitcoindiamond' },
      ratesApi: 'https://wallet.bitcoindiamond.org/bws/api/v1/fiatrates/BCD?provider=Binance',
      blockExplorerUrls: 'explorer.btcd.io/#/'
    },
    feeInfo: {
      feeUnit: 'sat/byte',
      feeUnitAmount: 1000,
